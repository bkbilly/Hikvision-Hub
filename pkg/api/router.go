...
func SetupRouter(cfg Config) http.Handler {
	...
	r.Route("/api", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Get("/cameras/{id}/live/audio", camHandler.LiveAudio)
			r.Post("/cameras/{id}/talk", camHandler.Talk)
			r.Post("/cameras/{id}/detect-audio", camHandler.DetectAudio)
			...
			r.Get("/cameras/{id}/isapi/scene-change", isapiHandler.GetSceneChangeDetection)
			r.Put("/cameras/{id}/isapi/scene-change", isapiHandler.SetSceneChangeDetection)
			r.Get("/cameras/{id}/isapi/face-detection", isapiHandler.GetFaceDetection)
			r.Put("/cameras/{id}/isapi/face-detection", isapiHandler.SetFaceDetection)
			r.Get("/cameras/{id}/isapi/events/{eventType}/schedule", isapiHandler.GetEventSchedule)
			r.Put("/cameras/{id}/isapi/events/{eventType}/schedule", isapiHandler.SetEventSchedule)
			r.Get("/cameras/{id}/isapi/events/{eventType}/linkage", isapiHandler.GetEventLinkage)
			r.Put("/cameras/{id}/isapi/events/{eventType}/linkage", isapiHandler.SetEventLinkage)
			...
			r.Get("/cameras/{id}/isapi/storage/quota", isapiHandler.GetStorageQuota)
			r.Put("/cameras/{id}/isapi/storage/quota", isapiHandler.SetStorageQuota)
			r.Get("/cameras/{id}/isapi/storage/schedule", isapiHandler.GetRecordSchedule)
			r.Put("/cameras/{id}/isapi/storage/schedule", isapiHandler.SetRecordSchedule)
			r.Get("/cameras/{id}/isapi/capture", isapiHandler.GetCaptureSettings)
			r.Put("/cameras/{id}/isapi/capture", isapiHandler.SetCaptureSettings)
